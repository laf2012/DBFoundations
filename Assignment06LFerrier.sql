...
AS
	SELECT DISTINCT vInventories.InventoryDate, CONCAT (vEmployees.EmployeeFirstName, ' ', vEmployees.EmployeeLastName) AS EmployeeName
	FROM vInventories
...
AS
	SELECT vCategories.CategoryName, vProducts.ProductName, vInventories.InventoryDate, vInventories.Count, CONCAT (vEmployees.EmployeeFirstName, ' ', vEmployees.EmployeeLastName) AS EmployeeName
	FROM vCategories
		INNER JOIN vProducts 
			ON vCategories.CategoryID = vProducts.CategoryID
		INNER JOIN vInventories 
...
AS
	SELECT CONCAT (Managers.EmployeeFirstName, ' ', Managers.EmployeeLastName) AS ManagerName, CONCAT (vEmployees.EmployeeFirstName, ' ', vEmployees.EmployeeLastName) AS EmployeeName
	FROM vEmployees 
		INNER JOIN vEmployees AS Managers ON Managers.EmployeeID = vEmployees.ManagerID 
...
AS
	SELECT vCategories.CategoryID, vCategories.CategoryName, vProducts.ProductID, vProducts.ProductName, vProducts.UnitPrice, vInventories.InventoryID, vInventories.InventoryDate, vInventories.Count, CONCAT (vEmployees.EmployeeFirstName, ' ', vEmployees.EmployeeLastName) AS EmployeeName, vEmployees.EmployeeID, CONCAT (Managers.EmployeeFirstName, ' ', Managers.EmployeeLastName) AS ManagerName
	FROM vCategories	
		INNER JOIN vProducts 
			ON vCategories.CategoryID = vProducts.CategoryID
		INNER JOIN vInventories 
		...
		INNER JOIN vEmployees
			ON vInventories.EmployeeID = vEmployees.EmployeeID
		INNER JOIN vEmployees AS Managers 
			ON Managers.EmployeeID = vEmployees.ManagerID 
